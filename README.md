...
另一个没有版权问题的词库是窝子 (Wozy) 创建的极爽词库，窝子在 2020 年将极爽五笔词库授权给了 Rime 官方使用，[详情见此](https://github.com/rime/rime-wubi/pull/3#issuecomment-577035306)。但是最后一版极爽词库 (极点五笔十周年纪念版) 自 2011 年发布之后就再没有维护过，因此极爽词库中的码表所包含的汉字也并不全面，只有 11589 个，在输入古汉语时经常找不到字。
...
有两个可以选择的极爽词库，一个是极爽 6.0 词库，另一个是让极点五笔成名的极爽 4.3 词库﻿(也是极点五笔 10 周年纪念版使用的词库)。极爽 6.0 词库大，重码率有 41%；极爽 4.3 词库的重码只有 19%。考虑到这里需要一个小词库，所以决定使用极爽 4.3 作为小词库的来源。极爽词库中共有 87984 个词条，其中包含 61395 个词组，符合要求。
